...
dataset3$`how would you rate your health` <-
  as.character(dataset3$`how would you rate your health`)
...
dataset3$`how would you rate your health` <-
  as.factor(dataset3$`how would you rate your health`)

names(dataset3)[names(dataset3) == "how would you rate your health"] <-
  "Mental Health Rating"

histogram <- ggplot(data = dataset3, mapping = aes(
  x =
